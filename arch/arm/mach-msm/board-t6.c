...
static struct platform_device t6_android_pmem_device = {
	.name = "android_pmem",
	.id = 0,
...
static struct platform_device t6_android_pmem_adsp_device = {
	.name = "android_pmem",
	.id = 2,
	.dev = { .platform_data = &android_pmem_adsp_pdata },
};

static struct android_pmem_platform_data t6_android_pmem_audio_pdata = {
	.name = "pmem_audio",
	.allocator_type = PMEM_ALLOCATORTYPE_BITMAP,
	.cached = 0,
	.memory_type = MEMTYPE_EBI1,
...
static struct msm_rtb_platform_data t6_rtb_pdata = {
...
static int __init msm_rtb_set_buffer_size(char *p)
{
	...
	s = memparse(p, NULL);
	t6_rtb_pdata.size = ALIGN(s, SZ_4K);
	return 0;
}
early_param("msm_rtb_size", msm_rtb_set_buffer_size);


static struct platform_device t6_rtb_device = {
       .name           = "msm_rtb",
       .id             = -1,
       .dev            = {
               .platform_data = &t6_rtb_pdata,
       },
};
#endif
...
static int t6_paddr_to_memtype(unsigned int paddr)
{
	return MEMTYPE_EBI1;
}
...
#ifdef CONFIG_MSM_MULTIMEDIA_USE_ION
static struct ion_cp_heap_pdata cp_mm_t6_ion_pdata = {
...
static struct ion_cp_heap_pdata cp_mfc_t6_ion_pdata = {
...
static struct ion_co_heap_pdata co_t6_ion_pdata = {
	.adjacent_mem_id = INVALID_HEAP_ID,
	.align = PAGE_SIZE,
	.mem_is_fmem = 0,
};

static struct ion_co_heap_pdata fw_co_t6_ion_pdata = {
...
struct ion_platform_heap apq8064_heaps[] = {
...
#ifdef CONFIG_MSM_MULTIMEDIA_USE_ION
		{
			...
			.extra_data = (void *) &cp_mm_t6_ion_pdata,
		...
		},
		{
			...
			.memory_type = ION_EBI_TYPE,
			.extra_data = (void *) &fw_co_t6_ion_pdata,
		},
		{
			...
			.memory_type = ION_EBI_TYPE,
			.extra_data = (void *) &cp_mfc_t6_ion_pdata,
		},
#ifndef CONFIG_MSM_IOMMU
		{
			...
			.memory_type = ION_EBI_TYPE,
			.extra_data = (void *) &co_t6_ion_pdata,
		},
#endif
		{
...
static struct platform_device t6_ion_dev = {
	.name = "ion-msm",
	.id = 1,
...
static void __init t6_calculate_reserve_sizes(void)
{
	size_pmem_devices();
	reserve_pmem_memory();
	reserve_ion_memory();
...
static struct reserve_info t6_reserve_info __initdata = {
	.memtype_reserve_table = apq8064_reserve_table,
	.calculate_reserve_sizes = t6_calculate_reserve_sizes,
	.reserve_fixed_area = apq8064_reserve_fixed_area,
	.paddr_to_memtype = t6_paddr_to_memtype,
};

static int t6_memory_bank_size(void)
{
	return 1<<29;
}
...
static void __init locate_unstable_memory(void)
{
	...
	t6_reserve_info.low_unstable_address = mb->start -
					MIN_MEMORY_BLOCK_SIZE + mb->size;
	t6_reserve_info.max_unstable_size = MIN_MEMORY_BLOCK_SIZE;

	t6_reserve_info.bank_size = bank_size;
	pr_info("low unstable address %lx max size %lx bank size %lx\n",
		t6_reserve_info.low_unstable_address,
		t6_reserve_info.max_unstable_size,
		t6_reserve_info.bank_size);
	return;
#endif
no_dmm:
	t6_reserve_info.low_unstable_address = high;
	t6_reserve_info.max_unstable_size = 0;
}
...
void t6_cable_detect_register(void)
{
	int rc;
...
static struct wcd9xxx_pdata t6_tabla_platform_data = {
...
static struct slim_device t6_slim_tabla = {
	.name = "tabla-slim",
	.e_addr = {0, 1, 0x10, 0, 0x17, 2},
	.dev = {
		.platform_data = &t6_tabla_platform_data,
	},
};

static struct wcd9xxx_pdata t6_tabla20_platform_data = {
	.slimbus_slave_device = {
		.name = "tabla-slave",
...
static struct slim_device t6_slim_tabla20 = {
	.name = "tabla2x-slim",
	.e_addr = {0, 1, 0x60, 0, 0x17, 2},
	.dev = {
		.platform_data = &t6_tabla20_platform_data,
	},
};
...
static struct msm_hdmi_platform_data hdmi_msm_data = {
	...
	.dirving_params_count = ARRAY_SIZE(t6_driving_params),
};
...
#ifdef CONFIG_ANDROID_PMEM
#ifndef CONFIG_MSM_MULTIMEDIA_USE_ION
	&t6_android_pmem_device,
	&t6_android_pmem_adsp_device,
	&t6_android_pmem_audio_device,
#endif
#endif
#ifdef CONFIG_ION_MSM
	&t6_ion_dev,
...
static struct msm_spi_platform_data t6_qup_spi_gsbi1_pdata = {
	.max_clock_speed = 48000000,
};

static struct msm_spi_platform_data t6_qup_spi_gsbi5_pdata = {
...
static struct slim_boardinfo t6_slim_devices[] = {
	{
		.bus_num = 1,
		.slim_slave = &t6_slim_tabla,
	},
	{
		.bus_num = 1,
		.slim_slave = &t6_slim_tabla20,
	},
...
static struct msm_i2c_platform_data t6_i2c_qup_gsbi3_pdata = {
	.clk_freq = 384000,
	.src_clk_rate = 24000000,
...
static struct msm_i2c_platform_data t6_i2c_qup_gsbi4_pdata = {
	.clk_freq = 400000,
	.src_clk_rate = 24000000,
	.share_uart_flag = 1,
};

static struct msm_i2c_platform_data t6_i2c_qup_gsbi7_pdata = {
	.clk_freq = 400000,
	.src_clk_rate = 24000000,
	.share_uart_flag = 1,
};
...
static void __init t6_i2c_init(void)
{
	...
	apq8064_device_qup_i2c_gsbi3.dev.platform_data =
					&t6_i2c_qup_gsbi3_pdata;
	apq8064_device_qup_i2c_gsbi4.dev.platform_data =
					&t6_i2c_qup_gsbi4_pdata;
	apq8064_device_qup_i2c_gsbi7.dev.platform_data =
					&t6_i2c_qup_gsbi7_pdata;
}
...
static void __init t6_init_dsps(void)
{
...
static void __init t6_common_init(void)
{
	...
	t6_init_pmic_register_cam_cb(&cam_vcm_on_cb, &cam_vcm_off_cb);
	
#endif

	register_i2c_devices();
	apq8064_device_qup_spi_gsbi1.dev.platform_data =
						&t6_qup_spi_gsbi1_pdata;
	apq8064_device_qup_spi_gsbi5.dev.platform_data =
						&t6_qup_spi_gsbi5_pdata;
	t6_init_pmic();
	...
	slim_register_board_info(t6_slim_devices,
		ARRAY_SIZE(t6_slim_devices));
	t6_init_dsps();

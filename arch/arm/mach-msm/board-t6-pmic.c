...
static const struct pm8xxx_adc_map_pt t6_adcmap_btm_table[] = {
	{-200,	1671},
	{-190,	1663},
	{-180,	1654},
	{-170,	1646},
...
static struct pm8xxx_adc_map_table pm8xxx_adcmap_btm_table = {
	.table = t6_adcmap_btm_table,
	.size = ARRAY_SIZE(t6_adcmap_btm_table),
};
...
void __init t6_init_pmic_register_cam_cb(void *cam_vcm_on_cb, void *cam_vcm_off_cb)
{
	if (cam_vcm_on_cb)
